    ...
    >
      ...
      <div className="grid gap-10 lg:grid-cols-2 lg:gap-12">
        ...
        <motion.div
          ...
          className=""
        >
          <h2 className="text-3xl font-bold text-black xl:text-5xl xl:leading-15 dark:text-[#f9fafb]">
            Let's{' '}
          ...
          <p className="text-gray text-xs leading-relaxed max-[376px]:pr-7 xl:text-[1rem] py-5">
