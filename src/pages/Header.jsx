    ...
    return (
        <header className={`fixed top-0 left-0 z-50 w-full border-b border-neutral-200 bg-white transition-all duration-200 dark:border-zinc-800 dark:bg-[#08090a] ${shadow && 'max-md:shadow-[0px_1px_2px_#000]'}`}>
            <motion.nav
                ...
                className="relative mx-auto flex h-16 w-full items-center justify-between border border-t-0 border-b-0 border-neutral-200 px-5 text-xs md:text-sm lg:h-20 lg:max-w-3xl xl:max-w-7xl dark:border-zinc-800"
            >
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a
                        ...
                        className="flex w-max items-center gap-2 border-2 border-black px-3 py-2 tracking-wide font-semibold shadow-[3px_3px_0px_#000] transition-all duration-150 hover:scale-110 hover:bg-black hover:text-white hover:shadow-none dark:border-zinc-800 dark:shadow-zinc-900 dark:hover:bg-zinc-900"
                    >
                        Resume
